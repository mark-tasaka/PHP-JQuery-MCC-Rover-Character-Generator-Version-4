...
<body>
    ...
    include 'php/gender.php';
        ...
        else
        {
            ...
            if(isset($_POST['theOptimizeAbilityScore']) && $_POST['theOptimizeAbilityScore'] == 1) 
            {
                ...
                $optimizeAbilityScoreMessage = "<br/>Ability Scores optimized in the order of Agi, Luck, Per, Int, Str, Sta.";
            }
            else
            {
    ...
    $attackBonusMelee = getAttackBonusMelee($level);
    $attackBonusMissile = getAttackBonusMissile($level);
